...
while True:
    try:
        ...
        if position_amt > 0 and entry_price:
            ...
            # Winst nemen bij TP of minimale netto winst
        ...
        # Optioneel: forceer SELL-signaal als kruis naar beneden,
        # maar alleen mits netto winst gehaald is.
        ...
        # Één netjes ingesprongen except-blok voorkomt IndentationError
        print(f"[runtime] {e}")
